...
{:refdef: style="text-align: center;"}
<iframe width="270" height="270" src="{{ site.baseurl }}/assets/img/helm/miner.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<iframe width="270" height="270" src="{{ site.baseurl }}/assets/img/helm/maze.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<iframe width="270" height="270" src="{{ site.baseurl }}/assets/img/helm/dodgeball.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
{: refdef}
